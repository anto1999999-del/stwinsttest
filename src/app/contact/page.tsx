...
export const metadata: Metadata = {
  ...
  description: "Contact S-Twins for premium car parts. Call (02) 9604 7366 or visit our locations in Smithfield NSW 2164 and Tuggerah NSW 2259. Get expert help finding the parts you need.",
  alternates: {
